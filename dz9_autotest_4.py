...
def dz9_autotest_4(my_browser):
    ...
    # Кнопка добавления
    button_add = my_browser.find_element(By.ID, 'addNewRecordButton')
    button_add.click()
    # Наполнение форм
    ...
    button_submit.click()
    # Сравнение введеных данных с полученной записью
    assert first_name == str(my_browser.find_element(By.XPATH, '//*[@id="app"]/div/div/div[2]/div[2]/div[2]/div[3]/div[1]/div[2]/div[4]/div/div[1]').text)
    assert last_name == str(my_browser.find_element(By.XPATH, '//*[@id="app"]/div/div/div[2]/div[2]/div[2]/div[3]/div[1]/div[2]/div[4]/div/div[2]').text)
    assert age == int(my_browser.find_element(By.XPATH, '//*[@id="app"]/div/div/div[2]/div[2]/div[2]/div[3]/div[1]/div[2]/div[4]/div/div[3]').text)
    assert email == str(my_browser.find_element(By.XPATH, '//*[@id="app"]/div/div/div[2]/div[2]/div[2]/div[3]/div[1]/div[2]/div[4]/div/div[4]').text)
    assert salary == int(my_browser.find_element(By.XPATH, '//*[@id="app"]/div/div/div[2]/div[2]/div[2]/div[3]/div[1]/div[2]/div[4]/div/div[5]').text)
    assert department == str(my_browser.find_element(By.XPATH, '//*[@id="app"]/div/div/div[2]/div[2]/div[2]/div[3]/div[1]/div[2]/div[4]/div/div[6]').text)
# Запуск
my_browser = init_browser()
dz9_autotest_4(my_browser)
my_browser.close()